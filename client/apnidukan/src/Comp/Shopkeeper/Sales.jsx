...
export default function Sales() {
  ...
  useEffect(() => {
    const fetchCustomers = async () => {
      try {
        const res = await axios.get("https://apnidukan-ngx3.onrender.com/getcus");
  ...
  const handleCustomerSelect = async (e) => {
    ...
    try {
      const res = await axios.get(
        `https://apnidukan-ngx3.onrender.com/getcus/${selectedCustomerId}`
      );
  ...
  const handleSubmitBill = async () => {
    ...
    try {
      const response = await axios.post(
        "https://apnidukan-ngx3.onrender.com/api/bills/createBill",
        billData
      );
